...
export const WithAction: Story = {
  args: {
    ...
    action: (
      <button className="bg-blue-900 text-white px-3 py-1 rounded hover:bg-blue-800">
        Update Now
      </button>
    ),
  ...
  args: {
    ...
    action: (
      <div className="flex space-x-2">
        <button className="bg-green-900 text-white px-3 py-1 rounded hover:bg-green-800">
          View File
        </button>
