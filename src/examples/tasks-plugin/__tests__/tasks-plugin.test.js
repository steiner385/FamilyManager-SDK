...
describe('TasksPlugin', () => {
    ...
    describe('Task Management', () => {
        ...
        it('should get tasks for a user', async () => {
            ...
            context.get.mockReturnValue('user-1');
        ...
        it('should create a task', async () => {
            ...
            const context = createMockContext();
            context.get.mockReturnValue('user-1');
            context.req.json.mockResolvedValue({
                title: 'Test Task',
                description: 'Test Description',
                priority: TaskPriority.MEDIUM,
                status: TaskStatus.PENDING
    ...
    describe('Event Handling', () => {
        ...
        it('should handle family.updated event', async () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith('Updated 2 tasks for family family-1');
        });
    });
...
//# sourceMappingURL=tasks-plugin.test.js.map