...
describe('FormManager', () => {
  ...
  interface FormState {
    ...
    touched: Partial<Record<keyof TestForm, boolean>>;
  ...
  let formManager: FormManager<TestForm>;
  ...
  beforeEach(() => {
    ...
    formManager = new FormManager({
      ...
      onSubmit: onSubmit as (values: TestForm) => Promise<void>,
    });
  });
  ...
  describe('Initialization', () => {
    ...
    it('should handle form without validation schema', () => {
      const simpleForm = new FormManager({
        initialValues,
        onSubmit: jest.fn(() => Promise.resolve()) as (values: TestForm) => Promise<void>,
      });
  ...
  describe('Submit Handling', () => {
    ...
    it('should handle successful submission', async () => {
      ...
      await formManager.handleSubmit(mockEvent as any);
  ...
  describe('Complex Scenarios', () => {
    ...
    it('should handle rapid state updates', async () => {
      ...
      const finalCall = subscriber.mock.calls[subscriber.mock.calls.length - 1][0] as FormState;
