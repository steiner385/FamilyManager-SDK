...
describe('RouteRegistry', () => {
    ...
    describe('Route Registration', () => {
        it('should register a route', () => {
            ...
            expect(logger.debug).toHaveBeenCalledWith('Registered route test-plugin:/test');
        });
        it('should handle route overwriting', () => {
            ...
            expect(logger.warn).toHaveBeenCalledWith('Route test-plugin:/test is already registered. Overwriting...');
        });
    ...
    describe('Route Unregistration', () => {
        ...
        it('should unregister route', () => {
            ...
            expect(logger.debug).toHaveBeenCalledWith('Unregistered route test-plugin:/test');
        });
        it('should handle unregistering non-existent route', () => {
            ...
            expect(logger.warn).toHaveBeenCalledWith('Route test-plugin:/non-existent is not registered');
        });
        it('should handle unregistering from non-existent plugin', () => {
            registry.unregisterRoute('non-existent-plugin', route);
            expect(logger.warn).toHaveBeenCalledWith('Route non-existent-plugin:/test is not registered');
        });
    });
    ...
    describe('Complex Scenarios', () => {
        ...
        it('should handle multiple operations in sequence', () => {
            ...
            // Register new route
            const newRoute = { path: '/route4', component: TestComponent };
            registry.registerRoute('test-plugin', newRoute);
            expect(registry.getAllRoutes()).toHaveLength(3);
            // Clear all routes
            registry.clearRoutes();
...
//# sourceMappingURL=RouteRegistry.test.js.map