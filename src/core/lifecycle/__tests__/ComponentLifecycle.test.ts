...
import { ComponentLifecycle, LifecycleHooks } from '../ComponentLifecycle';

type MockHook = () => Promise<void>;
type MockUpdateHook = (prevProps: any) => Promise<void>;
type MockErrorHook = (error: Error) => Promise<void>;
...
describe('ComponentLifecycle', () => {
  ...
  describe('Hook Registration', () => {
    it('should register lifecycle hooks', () => {
      const hooks: LifecycleHooks = {
        onMount: jest.fn(() => Promise.resolve()) as MockHook,
        onUnmount: jest.fn(() => Promise.resolve()) as MockHook,
        onUpdate: jest.fn(() => Promise.resolve()) as MockUpdateHook,
        onError: jest.fn(() => Promise.resolve()) as MockErrorHook,
      };
  ...
  describe('Hook Triggering', () => {
    it('should trigger mount hook', () => {
      const onMount = jest.fn(() => Promise.resolve()) as MockHook;
    ...
    it('should trigger unmount hook', () => {
      const onUnmount = jest.fn(() => Promise.resolve()) as MockHook;
    ...
    it('should trigger update hook with previous props', () => {
      const onUpdate = jest.fn(() => Promise.resolve()) as MockUpdateHook;
    ...
    it('should trigger error hook with error object', () => {
      const onError = jest.fn(() => Promise.resolve()) as MockErrorHook;
  ...
  describe('Multiple Component Handling', () => {
    it('should handle hooks for multiple components independently', () => {
      const component1Hooks: LifecycleHooks = {
        onMount: jest.fn(() => Promise.resolve()) as MockHook,
        onUnmount: jest.fn(() => Promise.resolve()) as MockHook,
      };

      const component2Hooks: LifecycleHooks = {
        onMount: jest.fn(() => Promise.resolve()) as MockHook,
        onUnmount: jest.fn(() => Promise.resolve()) as MockHook,
      };
  ...
  describe('Error Handling', () => {
    it('should handle errors in mount hook', async () => {
      ...
      const onMount = jest.fn(() => Promise.reject(error)) as MockHook;
      const onError = jest.fn(() => Promise.resolve()) as MockErrorHook;
    ...
    it('should handle errors in unmount hook', async () => {
      ...
      const onUnmount = jest.fn(() => Promise.reject(error)) as MockHook;
      const onError = jest.fn(() => Promise.resolve()) as MockErrorHook;
    ...
    it('should handle errors in update hook', async () => {
      ...
      const onUpdate = jest.fn(() => Promise.reject(error)) as MockUpdateHook;
      const onError = jest.fn(() => Promise.resolve()) as MockErrorHook;
    ...
    it('should handle errors in error hook', async () => {
      ...
      const onError = jest.fn()
        ...
        .mockImplementationOnce(() => Promise.resolve()) as MockErrorHook;
