...
describe('ComponentCustomizer', () => {
    const TestComponent = (props) => (_jsx("div", { style: props.style, className: props.className, onClick: props.onClick, children: props.title }));
    beforeEach(() => {
    ...
    it('should wrap component with customizations', () => {
        ...
        ComponentCustomizer.customize(pluginName, componentName, customizations);
        const CustomizedComponent = ComponentCustomizer.withCustomizations(TestComponent, pluginName, componentName);
        const { container } = render(_jsx(CustomizedComponent, {}));
    ...
    it('should merge styles correctly', () => {
        ...
        const { container } = render(_jsx(CustomizedComponent, { style: instanceStyles }));
        const element = container.firstChild;
    ...
    it('should merge props correctly', () => {
        ...
        ComponentCustomizer.customize(pluginName, componentName, customizations);
        const CustomizedComponent = ComponentCustomizer.withCustomizations(TestComponent, pluginName, componentName);
        const { container } = render(_jsx(CustomizedComponent, { title: "Instance Title", className: "instance-class" }));
        const element = container.firstChild;
    ...
    it('should handle multiple component customizations independently', () => {
        ...
        const CustomizedComponent1 = ComponentCustomizer.withCustomizations(TestComponent, pluginName, 'Component1');
        const CustomizedComponent2 = ComponentCustomizer.withCustomizations(TestComponent, pluginName, 'Component2');
        const { container: container1 } = render(_jsx(CustomizedComponent1, {}));
        const { container: container2 } = render(_jsx(CustomizedComponent2, {}));
    ...
    it('should handle undefined customizations gracefully', () => {
        ...
        ComponentCustomizer.customize(pluginName, componentName, customizations);
        const CustomizedComponent = ComponentCustomizer.withCustomizations(TestComponent, pluginName, componentName);
        const { container } = render(_jsx(CustomizedComponent, { title: "Test" }));
        const element = container.firstChild;
        expect(element.textContent).toBe('Test');
    });
    it('should handle component with no customizations', () => {
        const CustomizedComponent = ComponentCustomizer.withCustomizations(TestComponent, 'test-plugin', 'TestComponent');
        const { container } = render(_jsx(CustomizedComponent, { title: "Original", style: { margin: '10px' } }));
        const element = container.firstChild;
    ...
    it('should handle customizations from different plugins', () => {
        ...
        const CustomizedComponent1 = ComponentCustomizer.withCustomizations(TestComponent, 'plugin1', componentName);
        const CustomizedComponent2 = ComponentCustomizer.withCustomizations(TestComponent, 'plugin2', componentName);
        const { container: container1 } = render(_jsx(CustomizedComponent1, {}));
        const { container: container2 } = render(_jsx(CustomizedComponent2, {}));
        expect(container1.firstChild.style.color).toBe('red');
        expect(container2.firstChild.style.color).toBe('blue');
    });
});
//# sourceMappingURL=ComponentCustomizer.test.js.map